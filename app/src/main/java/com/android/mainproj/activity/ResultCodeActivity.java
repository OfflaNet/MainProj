...
public class ResultCodeActivity extends AppCompatActivity {
    ...
    private Button btn_res_code_send, btn_res_param_send, btn_req_code_send;

    private Button btn_code_move, btn_custom_list_move;
    ...
    {
        btn_res_code_back.setOnClickListener(listener_back_click);
        ...
        btn_custom_list_move.setOnClickListener(listener_res_custom_move);
    }
    ...
    private View.OnClickListener listener_back_click = new View.OnClickListener()
    {
        ...
        {
            setResult(RESULT_CODE_ACTIVITY_RESULT_CANCELED);
            finish();
        }
    };
    ...
    private View.OnClickListener listener_res_custom_move = new View.OnClickListener()
    {
        @Override
        public void onClick(View v)
        {
            ...
            if(reqCode == REQ_MAIN_ACTIVITY)
            {
                intent.putExtra("DATA", "CUSTOM_LIST_MOVE");
            }
